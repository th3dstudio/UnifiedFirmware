 ...
 */
 ...
 //Ender 3/5 V422 Board Settings
  ...
  #if (ENABLED(V422_TMC2208_BOARD) || ENABLED(ENDER3_V427_BOARD) || ENABLED(ENDER5_V422_BOARD) || ENABLED(ENDER5_V427_BOARD)) && ENABLED(LINEAR_ADVANCE)
  ...
  #if ENABLED(ENDER3_V427_BOARD) || ENABLED(ENDER5_V422_BOARD) || ENABLED(ENDER5_V427_BOARD)
