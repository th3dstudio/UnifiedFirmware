...
//===========================================================================
// *****************   CREALITY ENDER 7 V24S1_101 BOARD   *******************
//===========================================================================
//#define ENDER7
...
// See our helpcenter for pinouts for the V24S1_101 Board here: COMING SOON
 ...
 */
  ...
  #error "Linear Advance does NOT work on this board with the TMC drivers due to how Creality has them setup. Disable Linear Advance to continue or comment this line out to continue compile at your own risk."
#endif
...
//Ender 7 Settings
  ...
  #define DEFAULT_Kd 51.91
    ...
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, CUSTOM_ESTEPS_VALUE }
  #else
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 140 }
  #endif
