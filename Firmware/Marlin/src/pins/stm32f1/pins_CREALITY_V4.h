...
#define NO_SD_HOST_DRIVE                          // This board's SD is only seen by the printer
...
#if ANY(RET6_12864_LCD, HAS_DWIN_E3V2, IS_DWIN_MARLINUI, MKS_MINI_12864) //Added by TH3D
   ...
   *        ------
   */
  #if ANY(ENDER3_S1_12864_LCD, ENDER7) //Added by TH3D
  ...
  #if ENABLED(EZOUT_ENABLE) && DISABLED(EZOUT_ENABLE_J1) //Added by TH3D
    #define BEEPER_PIN                      -1
  #else
    #ifndef HAS_PIN_27_BOARD
