...
// If you have a 512K CPU please read the notes in the platformio.ini file for details on
...
// GD32 CPU Notes
// If you have a GD32 CPU you no longer need to change to a GD32 environment as the STM32 one work with those chips.
...
//===========================================================================
// *********   CREALITY PRINTERS W/V4.X.X BOARD - F103/F303 CPU   ***********
//===========================================================================
//------------------------------ V4.2.2 Board -------------------------------
#define ENDER3
//#define ENDER3_PRO
...
//#define ENDER5
//#define ENDER5_PRO
//#define ENDER5_PLUS //REQUIRES TH3D LCD KIT AND DUAL CABLE LCD ADAPTER BOARD
 ...
 * 
 * Connect the 5V (Brown Wire), GND (Blue Wire), and SIGNAL (Black Wire) to the 5 pin header.
 * Brown wire -> V Pin, Blue wire -> G Pin, Black wire -> OUT Pin
 */
...
//Ender 3 Max NEO Settings
  ...
  #if NONE(BLTOUCH, ENDER3_MAX_OEM, CUSTOM_PROBE)
    #define BLTOUCH
    #define CUSTOM_PROBE
...
//Ender 2 Pro Board Settings
  ...
  #if ANY(BLTOUCH_ON_5PIN, ZSENSE8)
    #define USE_PROBE_FOR_Z_HOMING
  #else
    #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
  #endif
...
#if ANY(ENDER3, ENDER5, ENDER3_MAX, ENDER5_PLUS)
  #if ENABLED(ENDER3_MAX, ENDER5_PLUS)
    #define MOUNTED_FILAMENT_SENSOR
  #endif
